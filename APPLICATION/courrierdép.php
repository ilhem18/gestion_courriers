...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6"  type='text/javascript' crossorigin="anonymous"></script>
...
<!--/menu-->
    ...
    <nav class="nav nav-pills nav-fill">
        <a class="nav-item nav-link" href="courrierarr.php">Courriers arrivés</a>
      <a class="nav-item nav-link active" href="courrierdép.php">Courriers départs</a>
    </nav>
    <!--/menu2-->
...
<div class="modal fade" id="ajoutcourrierdepmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form method="POST" action="insertdépart.php" enctype="multipart/form-data">
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form method="POST" action="insertdépart.php">
      <div class="modal-body">
